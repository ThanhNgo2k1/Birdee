<%-- 
    Document   : footer
    Created on : Jun 1, 2023, 1:17:29 PM
    Author     : Acer
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h5>THIÊN ĐƯỜNG MUA CHIM BIRDEE</h5>
                    <p class="m-0">Copyright@ 2023 Công ty cổ phần thương mại Birdee</p>
                    <p class="m-0">Tổng đài hỗ trợ: 19001221 - Email: cskh@hotro.birdee.vn</p>
                    <p class="m-0">Chịu Trách Nhiệm Quản Lý Nội Dung: Phạm Nhựt Dượng - Điện thoại liên hệ: 0969760721 (ext 4567)</p>
                    <p class="m-0">Địa chỉ: Tầng 61-62-63, Tòa nhà LandMark81, 720A Điện Biên Phủ, phường 22, quận Bình Thạnh, Thành phố Hồ Chí Minh, Việt Nam.</p>
                    <p class="m-0">Mã số doanh nghiệp: 0106999999 do Sở Kế hoạch & Đầu tư TP Hồ Chí Minh cấp lần đầu ngày 19/09/2023</p>
                    <p class="m-0">Bản quyền thuộc về Công ty TNHH Birdee</p>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <!-- <span class="box50 border border-white mr-3 "><i class="fa-brands fa-tiktok"></i></span>
                      <span class="box50 border border-white "><i class="fa-brands fa-instagram"></i></span> -->
                </div>
            </div>

            <hr>
            <div class="row">
                <div class="col-md-6"><div class="wsp">
                    Bản quyền thuộc về <a href="#" style="color: burlywood;">Birdee</a>
                    <span class="opacity1">
                        Cung cấp bởi 
                         <a href="#" style="color: burlywood;" rel="noopener" title="Sapo" target="_blank">Birdee</a> 
                    </span>
                </div></div>
                <div class="col-md-6 text-end f3">
                    <ul>
